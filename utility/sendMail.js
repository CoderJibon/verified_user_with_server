...
const sendMail = async (to,sub,data = {}) => {
   ...
   await transporter.sendMail({
        form    : `"Account verification" <${process.env.EMAIL_USER}>`,
        to      : to,
        subject : sub,
        html    : `<!DOCTYPE html>
